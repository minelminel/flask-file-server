...
icontypes = {
    'fa-music': datatypes['audio'], 
    'fa-archive': datatypes['archive'], 
    'fa-picture-o': datatypes['image'], 
    'fa-file-text': datatypes['pdf'], 
    'fa-film': datatypes['quicktime'], 
    'fa-code': datatypes['source'], 
    'fa-file-text-o': datatypes['text'], 
    'fa-film': datatypes['video'], 
    'fa-globe': datatypes['website']
}
...
if __name__ == '__main__':
    ...
    print(f'mount://{root}')
    app.run(bind, port, threaded=True, debug=True, use_reloader=False)
